/* $Header:   D:/databases/VMdb/archives/SFX/SFX CodeWarrior10/SFX_CW_10/SFXProject/Project_Headers/PE_Types.h_v   1.2.3.0   15 Dec 2015 16:14:58   hasanchez  $
************************************************************************************ 
...
Module name: PE_Types

Filename:    PE_Types.h
--------------------------- TECHNICAL NOTES -----------------------------------------

This code contains definitions of basic types, register access macros and 
hardware specific macros which can be used in user application.
Gernerated for MC9S08LG32CLH by Freescale

------------------------------ REVISIONS --------------------------------------------

 * $Log:   D:/databases/VMdb/archives/SFX/SFX CodeWarrior10/SFX_CW_10/SFXProject/Project_Headers/PE_Types.h_v  $
 * 
 *    Rev 1.2.3.0   15 Dec 2015 16:14:58   hasanchez
 * Fixes and changes done due the comments on the level 2 units.
 * 
 *    Rev 1.0   06 Aug 2012 05:27:28   akaushal
 * Initial revision.
 * 
 *    Rev 1.0   22 May 2012 12:00:48   ygupta
 * Initial revision.
